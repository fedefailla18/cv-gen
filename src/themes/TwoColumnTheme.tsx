  ...
  const renderSection = () => {
    switch (section) {
        ...
        return (
          <div className="mb-8 pb-6 border-b-2 border-indigo-500">
            ...
            <div className="flex flex-wrap gap-4 text-sm text-gray-700 mb-4">
              ...
              {data.url && <a href={data.url} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">🔗 {data.url}</a>}
              {data.location && (
      ...
      case 'work':
        ...
        return (
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-indigo-500">Work Experience</h2>
      ...
      case 'education':
        ...
        return (
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-indigo-500">Education</h2>
      ...
      case 'skills':
        ...
        return (
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-indigo-500">Skills</h2>
            <div className="space-y-4">
                  ...
                  {skill.keywords && Array.isArray(skill.keywords) && skill.keywords.length > 0 && (
                    <div className="flex flex-wrap gap-2 mt-2">
                      {skill.keywords.map((keyword: string, kIdx: number) => (
                        <span key={kIdx} className="px-2 py-1 bg-indigo-100 text-indigo-800 rounded text-sm">
                          {keyword}
                        </span>
                      ))}
                    </div>
      ...
      case 'languages':
        ...
        return (
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-indigo-500">Languages</h2>
            <div className="space-y-2">
              {data.map((lang: any, idx: number) => (
                <div key={idx} className="flex items-center justify-between border-l-4 border-indigo-500 pl-4">
