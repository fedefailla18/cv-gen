  ...
  const renderSection = () => {
    switch (section) {
      ...
      case 'work':
        ...
        return (
          <div className="mb-5">
            <h2 className="text-lg font-semibold text-gray-900 mb-2 pb-1 border-b border-gray-200">Work Experience</h2>
            <div className="space-y-3">
              {data.map((job: any, idx: number) => (
                <div key={idx} className="pl-2 border-l border-gray-200">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-1">
                    <div>
                      <h3 className="text-base font-semibold text-gray-900">{job.position || job.name}</h3>
                  ...
                  {job.summary && (
                    <p className="text-xs text-gray-700 mb-1.5 leading-relaxed mt-1">{job.summary}</p>
                  )}
      ...
      case 'education':
        ...
        return (
          <div className="mb-5">
            <h2 className="text-lg font-semibold text-gray-900 mb-2 pb-1 border-b border-gray-200">Education</h2>
            <div className="space-y-2">
              {data.map((edu: any, idx: number) => (
                <div key={idx} className="pl-2 border-l border-gray-200">
                  <h3 className="text-sm font-semibold text-gray-900">{edu.area || edu.studyType}</h3>
      ...
      case 'skills':
        ...
        return (
          <div className="mb-5">
            <h2 className="text-lg font-semibold text-gray-900 mb-2 pb-1 border-b border-gray-200">Skills</h2>
            <div className="space-y-2">
                  ...
                  {skill.keywords && Array.isArray(skill.keywords) && skill.keywords.length > 0 && (
                    <div className="flex flex-wrap gap-1 mt-1">
                      {skill.keywords.map((keyword: string, kIdx: number) => (
                        <span key={kIdx} className="px-1.5 py-0.5 bg-gray-100 text-gray-700 rounded text-xs">
                          {keyword}
                        </span>
                      ))}
                    </div>
      ...
      case 'languages':
        ...
        return (
          <div className="mb-5">
            <h2 className="text-lg font-semibold text-gray-900 mb-2 pb-1 border-b border-gray-200">Languages</h2>
            <div className="space-y-1">
              {data.map((lang: any, idx: number) => (
                <div key={idx} className="flex items-center justify-between pl-2 border-l border-gray-200">
